 ...
 */
public class Need extends Ad {
    private Integer l_price;
    private Integer h_price;

    public Need(Integer id, Integer creator_id, Integer product, String location, String name, String description, String thumb_url, Integer l_price, Integer h_price) {
